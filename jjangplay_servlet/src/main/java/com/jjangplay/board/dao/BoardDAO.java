...
public class BoardDAO extends DAO {
	...
	// SQL 문
//	final String LIST = "select no, title, writer, writeDate, hit from (select rownum rnum, no, title, writer, writeDate, hit from (select no, title, writer, to_char(writeDate, 'yyyy-dd-mm') writeDate, hit from board order by no desc)) where rnum>=? and rnum<=?";
	final String LIST = "select no, title, writer, writeDate, hit from (select rownum rnum, no, title, writer, writeDate, hit from (select no, title, writer, to_char(writeDate, 'yyyy-mm-dd') writeDate, hit from board";
	...
	final String WRITE = "insert into board (no, title, content, writer, pw) values (board_seq.nextval, ?, ?, ?, ?)";
